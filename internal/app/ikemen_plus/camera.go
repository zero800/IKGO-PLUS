...
type stageCamera struct {
	...
	tension        int32
	tensionhigh    int32 //not implemented yet
	tensionlow     int32 //not implemented yet
	floortension   int32
	overdrawhigh   int32 //not implemented yet
	overdrawlow    int32
	cuthigh        int32 //not implemented yet
	cutlow         int32 //not implemented yet
	localcoord     [2]int32
	localscl       float32
	zoffset        int32
	ztopscale      float32 //startzoom
	drawOffsetY    float32
}
...
type Camera struct {
	stageCamera
	ZoomEnable                  bool
	ZoomMin, ZoomMax, ZoomSpeed float32 //default ZoomMin, ZoomMax values set via lua, overwritten by stage zoomout, zoomin
	zoomdelay                   float32
...
func (c *Camera) Init() {
	...
	if c.verticalfollow > 0 {
		c.boundH = MinF(0, float32(c.boundhigh-c.starty)*c.localscl+
